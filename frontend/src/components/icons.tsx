...
export function BrandMark({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" aria-hidden="true">
      <path d="M35.5 10L17 36h11l-2.5 18L44 27H32l3.5-17z" fill="currentColor" />
    </svg>
  );
}
...
export function WandIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M15 4V2M15 10V8M11.5 6.5h-2M20.5 6.5h-2M17.8 3.7l-1.4 1.4M17.8 9.3l-1.4-1.4M3 21L14 10" />
    </svg>
  );
}
